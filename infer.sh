...
python ../inference.py --epoch -1 \
                       --val_data_path "/Work21/2021/fuyanjie/exp_data/sim_audio_vctk/sim_test_6_data" \
                       --test_data_path "/Work21/2021/fuyanjie/exp_data/sim_audio_vctk/sim_test_5_data" \
